package com.prodigal.aicode;

import org.mybatis.spring.annotation.MapperScan;
import org.springframework.boot.SpringApplication;
import org.springframework.boot.autoconfigure.SpringBootApplication;
import org.springframework.context.annotation.EnableAspectJAutoProxy;
//@MapperScan("com.prodigal.aicode.mapper")
@EnableAspectJAutoProxy(exposeProxy = true)
@SpringBootApplication
public class ProdigalAiCodeApplication {

    public static void main(String[] args) {
        SpringApplication.run(ProdigalAiCodeApplication.class, args);
        System.out.println("(♥◠‿◠)ﾉﾞ  prodigal-ai-code👉启动成功   ლ(´ڡ`ლ)ﾞ  \n" +
